...
<div id="primary" class="hero-content">
	...
	<div class="section-3">
		<div class="top-half">
			...
			<div class="thoughts">
				<div class="thought-1">
					<img src="http://localhost/michellerobinscreative/wp-content/uploads/2019/02/pillow-icon.png">
					<p>Coding is boring! Drag-and-drops may be limited, but they’ve been good enough for me so far.</p>
				</div>
				<div class="thought-2">
					<img src="http://localhost/michellerobinscreative/wp-content/uploads/2019/02/gear-icon.png">
					<p>I can make myself code, even though it takes forever and it's not my favorite part of the process.</p>
				</div>
				<div class="thought-3">
					<img src="http://localhost/michellerobinscreative/wp-content/uploads/2019/02/lightbulb-icon.png">
	...
	<div class="about-me" id="about">
		...
		<div class="photo half-width">
			<img src="http://localhost/michellerobinscreative/wp-content/uploads/2019/02/IMG_4153a.jpg"></div>
		</div>
